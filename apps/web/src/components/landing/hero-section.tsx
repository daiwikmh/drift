...
const words = ["discover", "pay", "unlock", "settle"];
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      {/* Background image — right-weighted so the focal art clears the
          left-aligned headline; swap src for your own /images/hero.png */}
      <div className="absolute inset-0 z-0 bg-black">
        ...
        />
        {/* darken the left so the headline stays legible (full-bleed on mobile) */}
        <div className="absolute inset-0 bg-gradient-to-r from-black via-black/70 to-black/20 lg:via-black/45 lg:to-transparent" />
        {/* darken top (for the nav) and bottom (for the stats row) */}
